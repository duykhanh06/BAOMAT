...
{
    internal class Controller : DatabaseHelper
    {
        List<Nhacungcap> Ds_NhaCungCap;

        public Controller()
        {
            Ds_NhaCungCap = new List<Nhacungcap>();
        }
        ...
        public List<Nhacungcap> Load()
        {
            ...
            return Ds_NhaCungCap;
        }


        public Nhacungcap get(String MaNCC)
        {
            foreach (Nhacungcap NCC in Ds_NhaCungCap)
            {
                if (NCC.getmanhacungcap() == MaNCC)
                {
                    return NCC;
                }
            }
        ...
        public bool Update(Nhacungcap NCC)
        {
            if (NCC != null && !string.IsNullOrEmpty(NCC.manhacungcap) && !string.IsNullOrEmpty(NCC.tennhacungcap) && !string.IsNullOrEmpty(NCC.diachi))
            {
                ...
                {
                    conn.Open();
                    SqlCommand cmd = new SqlCommand("update Kho set TenKho = @tenkho, DiaChi = @diachi where MaKho = @makho", conn);
        ...
        public bool Delete(string mancc)
        {
            if (!string.IsNullOrEmpty(mancc))
            {
                ...
                Ds_NhaCungCap.Remove(Ds_NhaCungCap.FirstOrDefault(k => k.getmanhacungcap() == mancc));
